...
GET_Nightly_Version="$(cat /tmp/Github_Tags | egrep -o "AutoBuild-phicomm-k3-R[0-9]+.[0-9]+.[0-9]+.[0-9]+.[a-z]" | awk 'END {print}' | egrep -o 'R[0-9]+.[0-9]+.[0-9]+.[0-9]+')"
GET_Stable_Version="$(cat /tmp/Github_Tags | egrep -o "AutoBuild-phicomm-k3-R[0-9]+.[0-9]+.[0-9]+.[0-9]+-Stable.[a-z]" | awk 'END {print}' | egrep -o 'R[0-9]+.[0-9]+.[0-9]+.[0-9]+-Stable')"
